...
module.exports = {
	...
	// Project options.
	projectName: 'envira',
	projectURL: 'localhost/envira', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	// Translation options.
	textDomain: 'envira', // Your textdomain here.
	translationFile: 'envira.pot', // Name of the translation file.
	translationDestination: './languages', // Where to save the translation files.
	packageName: 'Envira', // Package name.
